...
module.exports = class HelpCommand extends Command {
	...
	async run(msg, args) {
        ...
        .setDescription(client.registry.groups.map(c=> `• [${msg.guild.commandPrefix}yardım ${c.id}](https://kahvebot.com) => ${c.name}`))
        .setColor(0xf4a460)
        .setFooter(`Örnek Kullanım: ${msg.guild.commandPrefix}yardım kahve`)
